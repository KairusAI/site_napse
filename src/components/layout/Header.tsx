    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
          ...
          {/* Nav desktop */}
          <nav className={`hidden sm:flex flex-1 ${isScrolled ? 'justify-start' : 'justify-center'}`}>
            <div className="relative inline-flex items-center rounded-full bg-white/70 border border-white/80 shadow-[0_10px_35px_rgba(15,23,42,0.12)] px-2 py-1 backdrop-blur-xl">
              {isScrolled && (
                <motion.button
                  ...
                  className="flex shrink-0 items-center pr-2 pl-1"
                ...
                return (
                  <div key={item.id} className="relative px-0.5">
                    ...
                    <a
                      ...
                      className={`relative z-10 flex items-center gap-1.5 px-3 py-2 text-xs sm:text-sm font-medium transition-colors duration-200 lg:px-4 ${
